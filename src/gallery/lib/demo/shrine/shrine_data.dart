...
const Vendor _ali = const Vendor(
  name: 'Ali’s shop',
  avatarAsset: 'images/shrine/vendors/ali-connors.png',
  description:
...
const Vendor _sandra = const Vendor(
  name: 'Sandra’s shop',
  avatarAsset: 'images/shrine/vendors/sandra-adams.jpg',
  description:
...
const Vendor _trevor = const Vendor(
  name: 'Trevor’s shop',
  avatarAsset: 'images/shrine/vendors/zach.jpg',
  description:
...
const Vendor _peter = const Vendor(
  name: 'Peter’s shop',
  avatarAsset: 'images/shrine/vendors/peter-carlsson.png',
  description:
...
const Vendor _stella = const Vendor(
  name: 'Stella’s shop',
  avatarAsset: 'images/shrine/vendors/16c477b.jpg',
  description:
...
const List<Product> _allProducts = const <Product> [
  ...
  const Product(
    ...
    imageAsset: 'images/shrine/products/heels.png',
  ...
  const Product(
    name: 'Green Slip-ons',
    imageAsset: 'images/shrine/products/green-shoes.png',
  ...
  const Product(
    ...
    imageAsset: 'images/shrine/products/lipstick.png',
    categories: const <String>['fashion', 'beauty'],
    price: 54.00,
    vendor: _sandra,
    description:
  ...
  const Product(
    name: 'Backpack',
    imageAsset: 'images/shrine/products/backpack.png',
    categories: const <String>['travel', 'fashion'],
    price: 25.00,
    vendor: _peter,
    description:
  ...
  const Product(
    ...
    imageAsset: 'images/shrine/products/helmet.png',
  ...
  const Product(
    name: 'Lime Flippers',
    imageAsset: 'images/shrine/products/flippers.png',
    categories: const <String>['travel', 'fashion', 'beauty'],
    price: 25.00,
    vendor: _peter,
    description:
  ...
  const Product(
    name: 'Surfboard',
    imageAsset: 'images/shrine/products/surfboard.png',
