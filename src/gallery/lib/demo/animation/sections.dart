...
final List<Section> allSections = <Section>[
  const Section(
    ...
    rightColor: _mariner,
    backgroundAsset: 'images/shrine/products/sunnies.png',
  ...
  const Section(
    ...
    backgroundAsset: 'images/shrine/products/lawn_chair.png',
    details: const <SectionDetail>[
      _seatingDetail,
      _seatingImageDetail,
      _seatingDetail,
  ...
  const Section(
    ...
    leftColor: _mySin,
    rightColor: _tomato,
    backgroundAsset: 'images/shrine/products/lipstick.png',
    details: const <SectionDetail>[
      _decorationDetail,
  ...
  const Section(
    ...
    rightColor: _tomato,
    backgroundAsset: 'images/shrine/products/helmet.png',
    details: const <SectionDetail>[
      _protectionDetail,
